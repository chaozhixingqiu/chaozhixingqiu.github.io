# Python语法基础，IPython 和 Jupyter Notebooks {#basics}
...
```{r, fig.cap="表2-5 Datetime格式化指令（与ISO C89兼容）"}
knitr::include_graphics("https://upload-images.jianshu.io/upload_images/7178691-100f9a20c1536553.png")
```
